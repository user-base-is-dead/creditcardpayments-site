        ...
        <div className="footer-grid">
          ...
          <div className="footer-col footer-brand">
            ...
            <p className="footer-desc">
              Your trusted partner for secure credit card to bank transfers. Licensed and regulated.
            </p>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              <li><button onClick={() => handleNavClick('services')}>Money Transfer</button></li>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              <li><a href="https://wa.me/919999999999?text=Support" target="_blank" rel="noopener noreferrer">Contact Us</a></li>
